        ...
        <table summary="게시판 글쓰기">
            ...
            <tr>
                ...
                <td><textarea name="content" cols="50"
                        id="content"  rows="8" value="${vo.content}">${vo.content}</textarea></td>
            </tr>
            <tr>
            <th>첨부파일:</th>
            <td><input type="file" name="file" id="file"/>${vo.file_name}</td>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <input type="button" onclick="javascript:location.href" value="목록"/>
                </td>
            </tr>
            </tbody>
        </table>
